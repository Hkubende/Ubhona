...
export const tokens = {
  ...
  classes: {
    ...
    activeRow: "bg-primary/[0.09] shadow-[inset_0_1px_0_rgba(255,106,26,0.2)]",
    categoryChipActive: "border-primary/45 bg-primary/14 text-text-primary shadow-[0_0_0_1px_rgba(255,106,26,0.1),0_10px_24px_rgba(117,50,21,0.16)]",
