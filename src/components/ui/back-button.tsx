...
export function BackButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      className={cn(
        "inline-flex min-h-11 items-center rounded-2xl border border-border bg-[color:var(--color-surface)]/92 px-3 py-2 text-sm font-semibold text-text-primary shadow-subtle backdrop-blur transition duration-300 ease-out active:scale-[0.985] hover:border-primary/60 hover:bg-primary/12 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/55",
