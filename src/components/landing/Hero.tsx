  ...
  return (
    <section ref={heroRef} className="ubhona-landing-hero mb-12 mt-3 sm:mt-5">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] lg:items-center lg:gap-14">
        ...
        >
          <div className="pointer-events-none absolute right-[8%] top-[24%] h-44 w-44 rounded-full bg-orange-400/20 opacity-40 blur-3xl" />
          <div className="pointer-events-none absolute left-[18%] bottom-[16%] h-36 w-36 rounded-full bg-[#ffb066]/18 opacity-40 blur-3xl" />
          <motion.div
            animate={{ y: [0, -6, 0] }}
            transition={{ duration: 7.5, repeat: Infinity, ease: "easeInOut" }}
            whileHover={{ scale: 1.02 }}
            className="group relative w-full max-w-[440px] -translate-y-2 rounded-[28px] border border-white/10 bg-gradient-to-br from-white to-orange-50 p-2.5 shadow-[0_20px_60px_rgba(0,0,0,0.15)] backdrop-blur-xl transition duration-500 ease-out"
          >
            <div className="relative overflow-hidden rounded-[24px] bg-[linear-gradient(180deg,rgba(255,255,255,0.68),rgba(255,247,240,0.42))]">
